...
from FoodyAdmin.Apps.ManageUsers.utils import get_all_section_wtf_select
...
class AddNewUserForm(FlaskForm):
    ...
    NationalCode = StringField(
        validators=[
            DataRequired(message="ورود داده در این فیلد الزامی است"),
            InputRequired(message="ورود داده در این فیلد الزامی است"),
            Length(min=10, max=10, message="حداقل و حداکثر طول ورودی این فیلد 11 و 11 کاراکتر است"),
        ]
    )
